...
num_ACSy = 4    #ACS region along the y dimension
...
pre_img, pre_tstCsm, pre_img_dc, pre_ksp = IMJENSE.IMJENSE_Recon(tstDsKsp,SamMask,DEVICE,w0=w0,TV_weight=lamda,PolyOrder=15,MaxIter=1500,LrImg = 1e-4,LrCsm=0.1)
